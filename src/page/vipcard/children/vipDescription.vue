 <template>
  <div class="page_container">
        ...
        <div class="markdown">
            <blockquote>
                <p>尊敬的用户，随着会员体系逐渐完善，自2016年10月10日起，饱了么会员权益将做如下优化：
                购卡后31天内，累积享有30单减免配送费服务（每日最多3单，每单最高减免4元）。
                注：已购买的会员服务不受影响，当前会员服务失效前无法购买新卡。</p>
            </blockquote>
            <h3 id="q1-">Q1: 特权介绍</h3>
            <ul>
                <li>身份标识：饱了么会员服务有效期内，享有专属皇冠标识。</li>
                <li>减免配送费： 饱了么会员卡自绑定账户之日起31天内，在「蜂鸟专送」标识商家下单，享有30次减免配送费特权，每日最多减免3单，每单最高可减4元。</li>
                <li>更多特权，敬请期待！</li>
            </ul>
            <h3 id="q2-">Q2: 资费介绍</h3>
            <ul>
            ...
            <h3 id="q4-">Q4: 购卡说明</h3>
            <ul>
                <li>在线购买：饱了么App&gt;我的&gt;饱了么会员卡</li>
            </ul>
            <h3 id="q5-">Q5: 温馨提示</h3>
            <ul>
                <li>用户在当前会员服务失效前，无法购买新卡。</li>
                <li>请认准饱了么官方渠道，任何从其他第三方途径获得的会员卡，饱了么不保证其可用性。</li>
            </ul>
        </div>
    </div>
</template>
